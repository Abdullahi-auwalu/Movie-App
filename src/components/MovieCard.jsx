...
function MovieCard({ movie }) {
    return (
      <div className="flex sm:justify-start justify-center bg-white">
        <Link to={`/movies/${movie.id}`}> 
          ...
          <img className="z-0 mt-0 inset-0 w-screen h-full object-cover object-center" src={`https://image.tmdb.org/t/p/w500/${movie.poster_path}`} alt={movie.title} />
        </div>
        <p className="my-4 text-gray-400"> {movie.release_date}</p>
